...
class DatabaseConnector:
    ...
    def populate(self):
      with open("shipping_data_0.csv", "r") as spreadsheet_file_0: 
        with open("shipping_data_1.csv", "r") as spreadsheet_file_1:
            with open("shipping_data_2.csv", "r") as spreadsheet_file_2:
